...
export const solutions: Solution[] = [
  {
    id: "china-cloud-interconnect",
    name: "China Cloud Interconnect",
  ...
  {
    id: "china-private-line",
    name: "China Private Line",
  ...
  {
    id: "managed-china-network",
    name: "Managed China Network",
  ...
  {
    id: "china-access-acceleration",
    name: "China Access Acceleration",
