...
export const solutions: Solution[] = [
  {
    ...
    description:
      "Connect your China infrastructure directly to AWS, Azure, and GCP — at the bandwidth and price point that fits your workload. We offer the full spectrum: managed 1-10 Gbps virtual connections through Megaport and Equinix Fabric for cost-sensitive or moderate-traffic environments, and dedicated 10-100 Gbps physical cross-connects for data-heavy production workloads. Standard cloud provider partners cannot legally establish these China-to-overseas links. We can — with full compliance documentation and multiple active enterprise customers running production today.",
    benefits: [
      "Right-size your connectivity: managed 1-10 Gbps (Megaport/Equinix) or dedicated 10-100 Gbps — you decide",
